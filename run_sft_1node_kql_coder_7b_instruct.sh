...
ckpt_dir=/mnt/blob-data-sigmasystem-out/yuhang/system_data/Qwen2.5-7B-Coder-Instruct-Naive-kql-8k-0623
...
python \
    ...
    trainer.project_name=kql-coder-7b-instruct-0623 \
    trainer.experiment_name=kql-coder-7b-instruct-0623 \
