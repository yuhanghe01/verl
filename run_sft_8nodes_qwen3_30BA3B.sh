...
ckpt_dir=/mnt/blob-data-sigmasystem-out/yuhang/system_data/ckpt_4nodes_system_qwen3_30BA3B

torchrun --nnodes=8  --nproc_per_node=8 -m verl.trainer.fsdp_sft_trainer \
