...
ckpt_dir=/mnt/blob-data-sigmasystem-out/yuhang/system_data_Qwen2.5-Coder-32B
...
python \
    ...
    model.lora_rank=32 \
    trainer.project_name=system-sft-qwen2.5-coder-32b \
    trainer.experiment_name=system-sft-qwen2.5-coder-32b \
