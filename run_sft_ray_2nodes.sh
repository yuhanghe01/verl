...
python -c "import transformers; transformers.pipeline('text-generation',model='Qwen/Qwen2-0.5B-Instruct')"
...
ckpt_dir=/mnt/blob-data-sigmasystem-out/yuhang/system_data/ckpt_4nodes_system

python -m verl.trainer.fsdp_sft_trainer_ray \
