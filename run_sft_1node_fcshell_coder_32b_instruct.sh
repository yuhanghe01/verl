...
ckpt_dir=/mnt/blob-data-sigmasystem-out/yuhang/system_data/Qwen2.5-32B-Coder-Instruct-Naive-fcshell-0806
...
python \
    ...
    trainer.project_name=fcshell-coder-32b-instruct-0806-ltp \
    trainer.experiment_name=fcshell-coder-32b-instruct-0806-ltp \
