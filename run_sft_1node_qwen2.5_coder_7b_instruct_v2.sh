...
ckpt_dir=/mnt/blob-data-sigmasystem-out/yuhang/system_data_Qwen2.5-7B-Coder-Instruct-Naive_v2
...
python \
    ...
    trainer.project_name=sft-coder-7b-instruct-0614 \
    trainer.experiment_name=sft-coder-7b-instruct-0614 \
